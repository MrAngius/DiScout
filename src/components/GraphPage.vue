<template>
  ...
  <main id="page" class="w3-row">
    ...
    <aside id="tracked-products" v-bind:class="{'w3-hide': !tracklistOpen}">
      ...
      <product-list v-bind:categories="categories" :rating="rating" type="tracked" :price="price"/>
    </aside>
    ...
    <div id="track-page" v-bind:class="{ 'w3-hide': !isShowing }">
      ...
      <section id="similar-products-slider">
        ...
        <product-list v-bind:categories="categories" :rating="rating" type="suggested" :price="price"/>
      </section>
    </div>
  </main>
</template>
